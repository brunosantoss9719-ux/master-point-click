...
const scenes = [
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:'tela',label:'Tela com estática',x:91,y:26,dossier:'veto',lines:[['CAIO','A ação do BRB caiu. A notícia correu antes da explicação.'],['DANIEL','Explicação corre de sapato. Rumor nasce de motocicleta.']]},
