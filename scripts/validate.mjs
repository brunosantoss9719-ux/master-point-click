...
const required=['index.html','styles.css','app.js','manifest.webmanifest','sw.js','assets/icon-192.svg','assets/icon-512.svg','assets/office.webp','assets/boardroom.webp','assets/hangar.webp','assets/interview.webp','assets/characters.webp','assets/toffoli.webp','assets/stf-office.webp','AGENTS.md','PROJECT_STATE.md','SOURCES.md','STORY.md','ART_BIBLE.md'];
